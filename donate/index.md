...
<img width="80px" height="80px" src="{{ '/styles/images/zhifubao.jpg' | prepend: site.baseurl }}" alt="支付宝二维码付款给小可嗒嗒" />
...
![微信二维码付款给崔二爷]({{ '/styles/images/wechat.jpg' | prepend: site.baseurl }})
...
最后多说一句，欢迎大家关注我的[`Github`](https://cuigege.github.io)。虽然现在有用的东西不多，但会一直更新、努力。
